...
label_0 = Label(root, text="Registration Form",width=90,font=("bold", 16),bg="#180020",fg='white')
...
entry_9 = Entry(root,width=50,textvar=dob)
...
Button(root, text='Create dataset',width=15,bg='green',fg='white',command=dataset).place(x=150,y=670)
